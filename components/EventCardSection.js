...
function EventCardSection ({title, profileImage, username, reminder, eventImage, fullCapacity, enrolled}){
    const capacityPercentage = (fullCapacity && enrolled) ? (enrolled / fullCapacity) * 100 : 0;
    //console.log(capacityPercentage);
const validCapacityPercentage = isNaN(capacityPercentage) ? 0 : capacityPercentage;
